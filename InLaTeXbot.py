...
from PreambleManager import PreambleManager
...
class InLaTeXbot():
    ...
    def onStart(self, bot, update):
        update.message.reply_text("Hi there! I'm an inline LaTeX bot, and I can help you to send cool pictures with LaTeX to any chat. Just call me from there and give me the code, like this: @inlatexbot $x^2$\nYou can also type /help here to see list of available customization commands.")
