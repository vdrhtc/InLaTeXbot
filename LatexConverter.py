...
class LatexConverter():
    ...
    def __init__(self, templateLatexFile = "./resources/template.tex", pngResolution=720):
         self._templateLatexFile = templateLatexFile
    ...
    def  convertExpressionToPng(self, expression):
        ...
        with open(self._templateLatexFile, "r") as f:
        ...
        try:
            check_output(['/usr/bin/pdflatex', "-output-directory", "build", "resources/expression_file.tex"], stderr=STDOUT).decode("ascii")
